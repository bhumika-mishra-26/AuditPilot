      ...
      <div className="px-6 md:px-8 flex items-center justify-between relative z-10 w-full h-full">
        ...
        >
          <div className="relative">
            ...
            <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/20 relative z-10 transition-transform group-hover:scale-105">
